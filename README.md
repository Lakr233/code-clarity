...
A Claude Code skill for writing readable, intention-revealing code — precise naming, consistent abstraction levels, and the early-return pattern. Swift-primary with Go, TypeScript, and Python equivalents throughout.
